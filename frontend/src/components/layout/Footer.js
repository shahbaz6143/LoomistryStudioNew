      ...
      <footer className={styles.footer}>
        <div className={styles.container}>
          <div className={styles.grid}>
            ...
            <div className={styles.links}>
              <h4>Connect</h4>
              <a href="https://www.instagram.com/loomistrystudio/" target="_blank" rel="noopener noreferrer">Instagram</a>
              <a href="https://www.facebook.com/profile.php?id=61588571769641" target="_blank" rel="noopener noreferrer">Facebook</a>
              <a href="https://in.pinterest.com/loomistrystudio/" target="_blank" rel="noopener noreferrer">Pinterest</a>
              <a href="https://www.etsy.com/shop/theloomistrystudio/" target="_blank" rel="noopener noreferrer">Etsy Shop</a>
              <a href="https://wa.me/917428917452" target="_blank" rel="noopener noreferrer">WhatsApp</a>
            </div>
          </div>
