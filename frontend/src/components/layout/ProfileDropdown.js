    ...
    <div className={styles.wrapper} ref={ref}>
      ...
      {open && (
        <div className={styles.dropdown}>
          ...
          <Link href="/account" className={styles.item} onClick={() => setOpen(false)}>
            <svg width="16" height="16" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg>
            Saved Addresses
          </Link>
          <Link href="/account" className={styles.item} onClick={() => { setOpen(false); }}>
            <svg width="16" height="16" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24"><rect x="1" y="4" width="22" height="16" rx="2" ry="2"/><path d="M1 10h22"/></svg>
            Saved Cards
          </Link>
